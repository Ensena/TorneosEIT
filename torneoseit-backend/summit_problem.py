...
def summit_answer(id_problem,language,answer,kind): # all string less answer, it can be a text or a file- kind it is the type of the answer
...
def summit_problem (user,pwd,id_problem,language,answer,kind ): #(str) usuario ,(str) pass, (str) id problema,(str {0-1}) lenguaje, (str {0-1}) tipo de respuesta,({str - file} ) respuesta
	login_in(user,pwd)
	return summit_answer(id_problem,language,answer,kind)

summit_problem(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6])
driver.close()
#print(summit_problem(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6]))
